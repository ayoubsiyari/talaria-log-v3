#!/usr/bin/env python3
"""
Test real payment flow with Stripe configuration
"""
...
def test_real_payment_flow():
    """Test the complete payment flow with real Stripe configuration"""
    print("🧪 Testing real payment flow with Stripe configuration...")
    ...
    try:
        ...
        if response.status_code == 201:
            ...
            # Step 2: Simulate payment success (this is what the frontend should do)
